# Updating the bot code with the new bot name
bot_code_updated = """
...
file_path_updated = "/mnt/data/bot_kfdsjhfds.py"
with open(file_path_updated, "w", encoding="utf-8") as file:
    file.write(bot_code_updated)
